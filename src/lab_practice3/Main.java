...
public class Main {
    public static void main(String[] args) {
        ...
        //John Karry is a staff as well as student
        Person p10 = new Person("John Karry","451-5775", 25);
        dept.addPerson(p10);

        Staff stf4 = new Staff(5700);
        p10.addRole(stf4);

        Student st4 = new Student(3.98);
        p10.addRole(st4);
        st4.addCourse(c2);
        st4.addCourse(c5);


        System.out.println("Department total Salary after having John Kerry a staff and a student: "+ dept.getTotalSalary());
        dept.showAllMembers();
        dept.unitsPerFaculty();
    }
}
